...
{{--                <div class="nav-item giohang">--}}
{{--                    <li class="nav-item account" type="button">--}}
{{--                        <a href="{{ url('/login') }}" class="btn btn-secondary rounded-circle">--}}
{{--                            <i class="fa fa-user"></i>--}}
{{--                        </a>--}}
{{--                        <a class="nav-link text-dark text-uppercase" href="{{url('/login')}}" style="display:inline-block">Tài--}}
{{--                            khoản</a>--}}
{{--                    </li>--}}
{{--                </div>--}}
