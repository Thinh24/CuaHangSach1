                ...
                <div class="card">
                    <a href="Lap-trinh-ke-hoach-kinh-doanh-hieu-qua.html" class="motsanpham"
                       ...
                       title="Lập Kế Hoạch Kinh Doanh Hiệu Quả">
                        <img class="card-img-top anh" src="tem/images/lap-ke-hoach-kinh-doanh-hieu-qua.jpg"
                ...
                <div class="card">
                    <a href="Ma-bun-luu-manh-va-nhung-cau-chuyen-khac-cua-nguyen-tri.html" class="motsanpham"
                       ...
                       title="Ma Bùn Lưu Manh Và Những Câu Chuyện Khác Của Nguyễn
                        Trí">
                        <img class="card-img-top anh" src="tem/images/ma-bun-luu-manh.jpg" alt="ma-bun-luu-manh">
                        <div class="card-body noidungsp mt-3">
                ...
                <div class="card">
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       ...
                       title="Bank 4.0 - Giao dịch mọi nơi, không chỉ là ngân hàng">
                        <img class="card-img-top anh" src="tem/images/bank-4.0.jpg" alt="bank-4.0">
                        <div class="card-body noidungsp mt-3">
                ...
                <div class="card">
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       data-toggle="tooltip" data-placement="bottom" title="Bộ Sách 500 Câu Chuyện Đạo Đức - Những Câu Chuyện
                        Tình Thân (Bộ 8 Cuốn)">
                        <img class="card-img-top anh" src="tem/images/bo-sach-500-cau-chuyen-dao-duc.jpg"
                ...
                <div class="card">
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       ...
                       title="Lịch Sử Ung Thư - Hoàng Đế Của Bách Bệnh">
                        <img class="card-img-top anh" src="tem/images/ung-thu-hoang-de-cua-bach-benh.jpg"
                ...
                <div class="card">
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       ...
                       title="Cuốn Sách Khám Phá: Trời Đêm Huyền Diệu">
                        <img class="card-img-top anh" src="tem/images/troi-dem-huyen-dieu.jpg"
                    ...
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       ...
                       title="Bộ Sách Những Câu Chuyện Cho Con Thành Người Tử Tế (Bộ 5 Cuốn)">
                        <img class="card-img-top anh"
                             src="tem/images/bo-sach-nhung-cau-chuyen-cho-con-thanh-nguoi-tu-te.jpg"
                ...
                <div class="card">
                    <a href="#" class="motsanpham" style="text-decoration: none; color: black;"
                       data-toggle="tooltip" data-placement="bottom" title="Lịch Sử Thế Giới">
                        <img class="card-img-top anh" src="tem/images/lich-su-the-gioi.jpg" alt="lich-su-the-gioi">
                        <div class="card-body noidungsp mt-3">
