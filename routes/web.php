...
Route::get('/admin/orders', [\App\Http\Controllers\admin\BillController::class, 'viewAllBill']);
Route::get('/admin/bill/{id}', [\App\Http\Controllers\admin\BillController::class, 'viewBillById']);
Route::get('/admin/billDetail/{id}', [\App\Http\Controllers\admin\BillDetailController::class, 'viewBillDetails']);

//// Sửa
Route::put('/admin/bill/{id}/edit', [\App\Http\Controllers\admin\BillController::class, 'updateBillById']);
